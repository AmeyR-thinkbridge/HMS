    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishCategroy", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeedbackId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<short>(type: "smallint", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DishCategroyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dish", x => x.DishId);
                    table.ForeignKey(
                        name: "FK_Dish_DishCategroy_DishCategroyId",
                        column: x => x.DishCategroyId,
                        principalTable: "DishCategroy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceRecords_Dish_DishId",
                        column: x => x.DishId,
                        principalTable: "Dish",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dish_DishCategroyId",
                table: "Dish",
                column: "DishCategroyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishCategroy_CategoryCode",
                table: "DishCategroy",
                column: "CategoryCode",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceRecords_InvoiceId",
                table: "InvoiceRecords",
                column: "InvoiceId");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "TableNumber",
                unique: true,
                filter: "[TableNumber] IS NOT NULL");
        }
